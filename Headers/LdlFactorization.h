...
private:
    ...
    [[nodiscard]] double80_t GetBottomRowSum(uint64_t index, uint64_t currentRowIndex);

    [[nodiscard]] double80_t GetDiagonalRowSum(uint64_t currentRowIndex);
    ...
    void CalculateDiagonal(uint64_t index);
